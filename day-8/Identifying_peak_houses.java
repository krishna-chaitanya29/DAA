 ...
 */
 ...
 public class Identifying_peak_houses{
     ...
     public static void main(String[] args){
         ...
         getPeakHouses(arr, 0, n-1);
         Collections.sort(list);
         System.out.println(list);
     }
     
     public static void getPeakHouses(int[] arr, int low, int high){
         if (low>high){
             return;
         }
         ...
         getPeakHouses(arr, low, middle-1);
         getPeakHouses(arr, middle+1, high);
